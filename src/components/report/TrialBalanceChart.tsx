...
export const TrialBalanceChart: React.FC<Props> = ({ data }) => {
    ...
    const positionData = [
        { name: "สินทรัพย์", value: Math.abs(data.assets) },
        { name: "หนี้สิน", value: Math.abs(data.liabilities) },
        { name: "ส่วนของผู้ถือหุ้น", value: Math.abs(data.equity) },
    ].filter(item => item.value !== 0);
    ...
    sections.push(
        <div key="netprofit" className="flex flex-col items-center p-4 rounded-lg shadow w-full">
            ...
            <div className="bg-gradient-to-br from-green-50 via-blue-50 to-white dark:from-green-900 dark:via-blue-900 dark:to-neutral-900 rounded-lg shadow p-6 flex flex-col items-center w-full">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center md:justify-center mb-4 w-full">
                    <div className="flex flex-col items-center px-4 py-2 rounded-lg bg-blue-100 dark:bg-blue-800 w-full md:w-auto md:min-w-[160px]">
                    ...
                    <div className="flex flex-col items-center px-4 py-2 rounded-lg bg-green-100 dark:bg-green-800 w-full md:w-auto md:min-w-[160px]">
